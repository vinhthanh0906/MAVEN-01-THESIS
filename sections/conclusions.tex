...
\par
For this operation testing, Maven-01 operates on different terrain types like hard surfaces, grass, etc. In this test, MAVEN-01 4 motors version
used for better off road ability. 

\textbf{Image and Operate}
