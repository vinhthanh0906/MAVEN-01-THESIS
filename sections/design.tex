...
\subsection{Drive wheel design}

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/blueprint/drive_wheels.pdf}
    \caption{Driver wheels blueprint for MAVEN-01}
    \label{fig:drive_wheels}
\end{figure}

Each TT motor will have two drive wheels act as anchors for track chains attached, in single motor version chasis
two drive wheels will be use, four for the double motors version. 

\subsection{Frontpanel design}

\textbf(Log 18/4/2026: this go pretty well )
