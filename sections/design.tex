...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{images/blueprint/Maven-01-2nd-design.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\linewidth]{images/blueprint/chassis_1_engine.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/blueprint/front_wheel_6700zz_bearing_oriented.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/blueprint/front-center-axle-m5-bolt_drawing.pdf}
...
they can be easily changed when worn out,and chassis replacement will not be required. This design will save filament and maintenance time.
