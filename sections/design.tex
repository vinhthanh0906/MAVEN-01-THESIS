...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.79\linewidth]{images/blueprint/Maven-01-2nd-design.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.81\linewidth]{images/blueprint/front-center-axle-m5-bolt_drawing.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.81\linewidth]{images/blueprint/track_chain.pdf}
    \caption{Front axis for front wheels for M5 bolts}
