...
\vspace{1.5em }
\par
Maven-01 a was design for research, testing or educational purpose so every components are price affordable
for students and laboratory. The durability and easy maintenance will be also focused on for budget saving and 
reliability.


\textbf{Place holder for MAVEN 01 image}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.4\linewidth, angle=-90]{images/diagram/MAVEN-01-diagram.png}
    \caption{Maven 01 UML }
    \label{fig:maven_01_system_architecture}
