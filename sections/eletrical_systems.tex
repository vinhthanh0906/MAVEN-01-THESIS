...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/electrical_schematics/L298N.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/information/dht_11/dht11_specification.png}
    \caption{DHT11 detailed specification table including ideal working conditions and operating range}
    \label{fig:dht11_specification}
\end{figure}

%may need to correct again 
\includepdf[pages={5-9}]{doc/DHT11.pdf}
