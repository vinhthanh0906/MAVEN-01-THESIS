...
\input{sections/design.tex} %Structure design 

\input{sections/eletrical_systems.tex}
\newpage
\input{sections/monitoring_system.tex}
\newpage
...
%write your cite here
\nocite{*} % aboid funny hover red cite nuber 
\printbibliography
